...
Unordered list of possible extensions and work-in-progress. (Note: some ideas in the list may never be implemented; it will depend on relative priorities and availability)
...
1. "Higher-Order Polarizability Tensors" conversion from T-matrix, after 10.1021/acsphotonics.9b01776

## User level

1. Import of T-matrices in HDF5 format
