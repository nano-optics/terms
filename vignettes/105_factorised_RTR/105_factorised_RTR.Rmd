...
This example illustrates the two ways to calculate VTACS. We compare the far-field spectra for a linear chain of gold spheres, with and without the `DisableRTR` keyword. 
