...
Note that TERMS will automatically detect whether a point is within a given region, and return this information in the near-field map. This is helpful to combine multiple regions as in this example, without needing to run separate simulations, or keep track of the regions ourselves.
